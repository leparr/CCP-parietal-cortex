...
def plot_kde (w_plast, synapse_type):
    '''
    Method to plot the Kernel Density Estimation on learned plastic wieghts
    ...
    Returns :
        the Kernel Density Estimation plot forthe loaded plastic weight divided by class encoded
    '''
